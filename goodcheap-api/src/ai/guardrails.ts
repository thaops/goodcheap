/**
 * System/developer prompt for guardrailed analysis (verifiable-by-design).
 * Không nhúng vào output JSON. Chỉ dùng khi gọi LLM.
 */
export function buildSystemPrompt(schemaVersion = 'v1'): string {
  return `
